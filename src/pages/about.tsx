    ...
    return (
        <div className="min-h-screen bg-neutral-950 py-8">
            <div className="w-1/2 mx-auto">
                ...
                <p className="text-gray-200 mb-2 ">Musimetrics adheres to all modern standards in web security and logging in to spotimetrics is handled by Spotify so it is as secure as Spotify itself</p>
