    ...
    return (
        <div className="min-h-screen bg-neutral-950 py-8">
            <div className="w-2/3 mx-auto">
                ...
                <p className="text-gray-200 mb-2 ">The website only has access to your spotify profile, top items, and recently played tracks. Data is only used by the browser to display these items or calculate additional metrics such as your favorite genre or decade of music.</p>
                <p className="text-gray-200 mb-2 font-bold">This feature doesn&rsquo;t work</p>
                <p className="text-gray-200 mb-2 ">If you listen in private mode or have a new account there might be limited data. If there is a major bug. Let me know by Github or Email.</p>
                <p className="text-gray-200 mb-2 font-bold">How was this made</p>
                <p className="text-gray-200 mb-2">All the source code is open sourced on <a href="https://github.com/TarunR3/Musimetrics" className="text-blue-500 hover:underline">Github</a>!</p>
            </div>
        </div>
    );
};
