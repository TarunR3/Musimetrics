    ...
    return (
        <div className="min-h-screen bg-neutral-950 py-8">
            <div className="w-1/2 mx-auto">
                ...
                <p className="text-gray-200 mb-2">Spotimetrics allows you to use your Spotify data in order to see various data about your music listening stats. It uses Spotify&rsquo;s Web API to display your listening to history, top tracks, artists, genres, albums and much more.</p>
