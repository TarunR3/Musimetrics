    ...
    return (
        <div className="min-h-screen bg-neutral-950 py-8">
            <div className="w-1/2 mx-auto">
                <p className="text-gray-200 mb-2 font-bold text-5xl border-b pb-2">About Spotimetrics</p>
                <p className="text-gray-200 mb-2">Spotimetrics allows you to use your Spotify data in order to see various data about your music listening stats. It uses Spotify's Web API to display your listening to history, top tracks, artists, genres, albums and much more.</p>
                <p className="text-gray-200 mb-2  pt-10 pb-2 font-bold text-lg border-b">Disclaimer</p>
                <p className="text-gray-200 mb-2">Please note that this website is not affiliated with or endorsed by Spotify in any way. I do not own any of the images, tracks, or other content provided by Spotify through the API, and all such content remains the property of its respective owners. The use of Spotify's API is solely for the purpose of providing access to Spotify content on this website. I do not claim ownership or control over any of the content provided by Spotify, and I cannot guarantee the accuracy or availability of any such content.</p>
                ...
                <p className="text-gray-200 mb-2 ">Spotimetrics adheres to all modern standards in web security and logging in to spotimetrics is handled by Spotify so it is as secure as Spotify itself</p>
                ...
                <p className="text-gray-200 mb-2 font-bold">This feature doesn't work</p>
